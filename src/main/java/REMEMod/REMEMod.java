...
import REMEMod.Cards.Blue.Power.ColdRelease;
import REMEMod.Cards.Blue.Power.MagicShapingShield;
...
import REMEMod.Cards.Red.Power.Unstoppable;
...
import REMEMod.Relics.Uncommon.*;
...
public class REMEMod implements EditRelicsSubscriber, EditStringsSubscriber, EditCardsSubscriber, PostInitializeSubscriber, EditKeywordsSubscriber, OnStartBattleSubscriber {
    ...
    public void receiveEditCards() {
        ...
        BaseMod.addCard(new MagicShapingShield());
        BaseMod.addCard(new ColdRelease());
    ...
    public void receiveEditRelics() {
        ...
        BaseMod.addRelic(new WhiteStar(), RelicType.SHARED);
        BaseMod.addRelic(new Singularity(), RelicType.SHARED);
        BaseMod.addRelic(new BottledBoat(), RelicType.SHARED);
