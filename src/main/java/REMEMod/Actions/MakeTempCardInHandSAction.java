...
public class MakeTempCardInHandSAction extends AbstractGameAction {
    private AbstractCard c;
    private static final float PADDING;
    private boolean isOtherCardInCenter;
    private boolean sameUUID;

    public MakeTempCardInHandSAction(AbstractCard card, boolean isOtherCardInCenter) {
    ...
    public MakeTempCardInHandSAction(AbstractCard card) {
        this(card, 1);
    }

    public MakeTempCardInHandSAction(AbstractCard card, int amount) {
        this.isOtherCardInCenter = true;
        this.sameUUID = false;
        UnlockTracker.markCardAsSeen(card.cardID);
        this.amount = amount;
    ...
    public MakeTempCardInHandSAction(AbstractCard card, int amount, boolean isOtherCardInCenter) {
        this(card, amount);
        this.isOtherCardInCenter = isOtherCardInCenter;
    }

    public MakeTempCardInHandSAction(AbstractCard card, boolean isOtherCardInCenter, boolean sameUUID) {
        this(card, 1);
        this.isOtherCardInCenter = isOtherCardInCenter;
