...
import REMEMod.Powers.RepentancePower;
...
public class Repentance extends CustomCard {
    private static final String ID = "REME_Repentance";
    private static CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    private static final String NAME = cardStrings.NAME;
    private static final String DESCRIPTION = cardStrings.DESCRIPTION;
    private static final String IMG_PATH = "remeImg/cards/Repentance.png";
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        this.addToBot(new ApplyPowerAction(p,p,new RepentancePower(p,magicNumber)));
    }
