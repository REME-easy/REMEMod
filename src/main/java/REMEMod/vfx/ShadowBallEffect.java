...
public class ShadowBallEffect extends AbstractGameEffect {
    ...
    public ShadowBallEffect(float startX, float startY, float targetX, float targetY, int timesUpgraded) {
    ...
    public void update() {
        ...
        if (this.vfxTimer < 0.0F) {
            ...
            AbstractDungeon.effectsQueue.add(new ShadowBurstParticleEffect(this.x, this.y, this.timesUpgraded));
            AbstractDungeon.effectsQueue.add(new ShadowBurstParticleEffect(this.x, this.y, this.timesUpgraded));
        }
