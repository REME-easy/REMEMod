...
public class ShadowBurstParticleEffect extends AbstractGameEffect {
    ...
    public ShadowBurstParticleEffect(float x, float y, int timesUpgraded) {
        ...
        this.color = new Color(MathUtils.random(0.9F, 1.0F), MathUtils.random(0.0F, 1.0F), MathUtils.random(0.8F, 1.0F), 0.0F);
        this.color.a = 0.0F;
